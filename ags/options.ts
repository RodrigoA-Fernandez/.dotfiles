...
import { getColors } from "style/colors"
...
const options = mkOptions(OPTIONS, {
  ...
  theme: {
    dark: {
      primary: {
        bg: opt(colors["primary-bg"]),
        fg: opt(colors["primary-fg"]),
      },
      error: {
        // bg: opt(colors["error-bg"]),
        bg: opt(colors["error-bg"]),
        fg: opt(colors["error-fg"]),
      },
      bg: opt("#171717"),
      fg: opt("#eeeeee"),
      widget: opt("#eeeeee"),
  ...
  bar: {
    ...
    battery: {
      ...
      charging: opt(colors["charging-fg"]),
      percentage: opt(true),
      blocks: opt(7),
      width: opt(50),
      low: opt(30),
